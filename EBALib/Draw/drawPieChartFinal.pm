# $Id$ Draw Final Pie Chart
# Perl module for EBA EBALib::Draw::drawPieChartFinal;
...
EBALib::Draw::drawPieChartFinal  - DESCRIPTION of Object
...
package EBALib::Draw::drawPieChartFinal;
...
#print "Generating pie chart for final table .. .\t\n";
		 ...
		 opendir(DIR, $dir) or die $!;
			...
			my @new_file=split(/_/, $file);
				if ($new_file[0] ne "") { 
					...
					my $OutPutFile= "$path/EBA_ImageFiles/Pie_chart_classified_EBRs_$resName.gif";
					my $OutPutFile2= "$path/EBA_ImageFiles/Pie_chart_classified_EBRs_$resName.data";
					drawPieChart($InPutFile, $OutPutFile, $OutPutFile2, $spsNum, $resName);
...
my ($InPutFile, $OutPutFile, $OutPutFile2, $spsNum, $resName) = @_;
...
$my_graph->set( 
'title'=> "Percentage of EBRs per species and phylogenetic groups at $resName Kbp resolution (classified)", # $resName Kb EBRs",
