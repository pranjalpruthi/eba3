# $Id$ Draw Chromosome Line Graph2
# Perl module for EBA EBALib::Draw::drawBrkChrLineGraphFinal2;
...
EBALib::Draw::drawBrkChrLineGraphFinal2  - DESCRIPTION of Object
...
package EBALib::Draw::drawBrkChrLineGraphFinal2;
...
my @spsArray = sort { $a cmp $b } @spsArr;
	...
	$speciesName =~ s/_/ /ig; ## To replace the _ with " " in name
...
$my_graph->set(
	'title' => "Density of EBRs per chromosome size at $resName Kb resolution", #graph title
	'y_label' => 'No. EBRs per Mbp', #y-axis label
	'x_label' => 'Reference chromosomes size (Mbp)',
...
$my_graph->set_title_font(['verdana', 'arial', gdMediumBoldFont],18); 
